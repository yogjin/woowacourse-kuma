...
- 입력 유효성 위배
  - [ ] 3자리의 수가 아닌 경우 텍스트 `서로 다른 3자리의 수를 입력해 주세요.`
  - [ ] 각 자릿수가 1에서 9사이의 숫자가 아닌 경우 텍스트 `각 자릿수는 1에서 9사이의 숫자로 입력해 주세요.`
  - [ ] 각 자릿수가 각각 서로 다른 숫자가 아닌 경우 텍스트 각 자릿수는 `서로 다른 숫자로 입력해 주세요.`
